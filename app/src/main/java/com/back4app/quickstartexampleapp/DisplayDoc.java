...
public class DisplayDoc extends AppCompatActivity {
    ...
    public final static String EXTRA_docId = "com.back4app.quickstartexampleapp.DOCID";
    public final static String EXTRA_curId = "com.back4app.quickstartexampleapp.CURID";
